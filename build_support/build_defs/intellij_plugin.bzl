...
_intellij_plugin_jar = rule(
    ...
    attrs = {
        ...
        "_merge_xml_binary": attr.label(
            default = Label("//build_support/build_defs:merge_xml"),
            executable = True,
            cfg = "host",
        ),
        "_append_optional_xml_elements": attr.label(
            default = Label("//build_support/build_defs:append_optional_xml_elements"),
            executable = True,
            cfg = "host",
        ),
        "_package_meta_inf_files": attr.label(
            default = Label("//build_support/build_defs:package_meta_inf_files"),
            executable = True,
            cfg = "host",
        ),
    },
